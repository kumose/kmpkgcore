...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" BUILD_DYNAMIC_LIBS)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DBUILD_TESTS=OFF
        ${FEATURE_OPTIONS}
        -DENABLE_COREAUDIO=${KMPKG_TARGET_IS_OSX}
        -DENABLE_WASAPI=${KMPKG_TARGET_IS_WINDOWS}
)
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/soundio/soundio.h" "defined(SOUNDIO_STATIC_LIBRARY)" "1")
endif()
