if(KMPKG_TARGET_IS_LINUX AND NOT X_KMPKG_FORCE_KMPKG_GETTEXT_LIBINTL)
    ...
    block(SCOPE_FOR VARIABLES)
        ...
        kmpkg_cmake_configure(SOURCE_PATH "${CURRENT_PORT_DIR}/detect" OPTIONS "-DOUTFILE=${detection_results}")
    endblock()
    include("${detection_results}")
    message(STATUS "libintl header: ${KMPKG_DETECTED_LIBINTL_H}")
    if(NOT KMPKG_DETECTED_LIBINTL_H)
        message(FATAL_ERROR
...
if(KMPKG_TARGET_IS_WINDOWS)
    list(APPEND OPTIONS
        ...
        # Cf. https://github.com/microsoft/kmpkg/issues/35974
...
file(COPY "${CMAKE_CURRENT_LIST_DIR}/kmpkg-cmake-wrapper.cmake" DESTINATION "${CURRENT_PACKAGES_DIR}/share/intl")
file(COPY "${CMAKE_CURRENT_LIST_DIR}/usage" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/gettext-runtime/intl/COPYING.LIB")
