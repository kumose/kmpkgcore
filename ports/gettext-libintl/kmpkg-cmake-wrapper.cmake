...
if(Intl_FOUND AND Intl_LIBRARIES)
    ...
    find_library(Intl_LIBRARY_DEBUG NAMES intl libintl intl-8 NAMES_PER_DIR PATH_SUFFIXES lib PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug" NO_DEFAULT_PATH)
    find_library(Intl_LIBRARY_RELEASE NAMES intl libintl intl-8 NAMES_PER_DIR PATH_SUFFIXES lib PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}" NO_DEFAULT_PATH)
