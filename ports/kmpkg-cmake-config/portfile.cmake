if(NOT TARGET_TRIPLET STREQUAL _HOST_TRIPLET)
    ...
    message(WARNING "kmpkg-cmake-config is a host-only port; please mark it as a host port in your dependencies.")
endif()

file(INSTALL
    "${CMAKE_CURRENT_LIST_DIR}/kmpkg_cmake_config_fixup.cmake"
