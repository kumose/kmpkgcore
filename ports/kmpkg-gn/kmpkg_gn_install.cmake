...
function(z_kmpkg_gn_install_get_target_type out_var)
...
function(z_kmpkg_gn_install_get_desc out_var)
...
function(z_kmpkg_gn_install_install)
    ...
    foreach(target IN LISTS arg_TARGETS)
        ...
        z_kmpkg_gn_install_get_desc(outputs
            SOURCE_PATH "${arg_SOURCE_PATH}"
            BUILD_DIR "${arg_BUILD_DIR}"
            TARGET "//${target}"
            WHAT_TO_DISPLAY outputs
        )
        z_kmpkg_gn_install_get_target_type(target_type
            SOURCE_PATH "${arg_SOURCE_PATH}"
            BUILD_DIR "${arg_BUILD_DIR}"
            TARGET "//${target}"
        )
