...
if(WITH_OTLP_FILE OR WITH_OTLP_GRPC OR WITH_OTLP_HTTP)
    ...
    kmpkg_extract_source_archive(src ARCHIVE "${ARCHIVE}")
    ...
    list(APPEND FEATURE_OPTIONS "-DgRPC_CPP_PLUGIN_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/grpc/grpc_cpp_plugin${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
