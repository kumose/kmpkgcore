...
# This feature does not exist, but allows us to simplify the kmpkg.json
# file.
...
# are invalid in `kmpkg` features, we use dashes (`-`) as a separator
# for the `kmpkg` feature name, and convert it here to something that
...
function (google_cloud_cpp_cmake_config_fixup library)
    ...
    # If the library exists and is installed, tell kmpkg about it.
    if(NOT IS_DIRECTORY "${CURRENT_PACKAGES_DIR}/${config_path}")
        return()
    endif()
    kmpkg_cmake_config_fixup(PACKAGE_NAME "google_cloud_cpp_${library}"
