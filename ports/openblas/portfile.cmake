...
# Adapting this to kmpkg triplets:
...
string(REPLACE "WindowsStore_" "_" SYSTEM_KEY "${KMPKG_CMAKE_SYSTEM_NAME}_${KMPKG_TARGET_ARCHITECTURE}")
...
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/OpenBLAS)
kmpkg_fixup_pkgconfig()

# Required from native builds, optional from cross builds.
if(NOT KMPKG_CROSSCOMPILING OR EXISTS "${CURRENT_PACKAGES_DIR}/bin/getarch${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
    kmpkg_copy_tools(
