...
if(KMPKG_USE_INTERNAL_Fortran)
    set(KMPKG_CRT_LINKAGE dynamic) # Will always be dynamic no way to overwrite internal CRT linkage here
    ...
    set(MINGW_BIN "${kmpkg_find_fortran_MSYS_ROOT}/mingw${MINGW_W_TARGET}/bin/")
    ...
    file(COPY "${kmpkg_find_fortran_MSYS_ROOT}/mingw${MINGW_W_TARGET}/share/licenses" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
    file(INSTALL "${kmpkg_find_fortran_MSYS_ROOT}/mingw${MINGW_W_TARGET}/share/licenses/crt/COPYING.MinGW-w64-runtime.txt" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}" RENAME copyright)
