...
if(Iconv_FOUND AND NOT Iconv_IS_BUILT_IN)
    find_path(CHARSET_INCLUDE_DIR NAMES "libcharset.h" HINTS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/include")
    find_library(CHARSET_LIBRARY_DEBUG NAMES charsetd libcharsetd charset libcharset NAMES_PER_DIR PATH_SUFFIXES lib HINTS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug")
    find_library(CHARSET_LIBRARY_RELEASE NAMES charset libcharset NAMES_PER_DIR PATH_SUFFIXES lib HINTS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}")
