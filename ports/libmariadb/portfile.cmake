...
if(KMPKG_TARGET_IS_WINDOWS AND "openssl" IN_LIST FEATURES)
    message(WARNING "Using OpenSSL instead of schannel.")
endif()

kmpkg_download_distfile(fp_is_not_const_patch
...
string(TOUPPER "${KMPKG_LIBRARY_LINKAGE}" plugin_type)
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-libmariadb)
...
if(NOT link_lib STREQUAL " -lmariadb")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libmariadb.pc" " -lmariadb" "${link_lib}")
    if(NOT KMPKG_BUILD_TYPE)
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libmariadb.pc" " -lmariadb" "${link_lib}")
    endif()
endif()
