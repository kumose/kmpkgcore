...
function(kmpkg_get_kmpkg_installed_python out_python)
  cmake_parse_arguments(PARSE_ARGV 1 "arg" "INTERPRETER" "" "")
  if(DEFINED arg_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION} was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
  endif()
  if(NOT KMPKG_TARGET_IS_WINDOWS)
    # kmpkg installed python on !windows works as normal python would work.
    set(${out_python} "${CURRENT_HOST_INSTALLED_DIR}/tools/python3/python3" PARENT_SCOPE)
    return()
  endif()
  if(DEFINED CACHE{z_kmpkg_get_kmpkg_installed_python})
    set(${out_python} "${z_kmpkg_get_kmpkg_installed_python}" PARENT_SCOPE)
    return()
  elseif(arg_INTERPRETER AND DEFINED CACHE{z_kmpkg_get_kmpkg_installed_python_interpreter})
    set(${out_python} "${z_kmpkg_get_kmpkg_installed_python_interpreter}" PARENT_SCOPE)
    return()
  endif()
...
kmpkg_bin_path = Path(sys.base_prefix + '/../../bin')
if kmpkg_bin_path.is_dir():
  os.add_dll_directory(kmpkg_bin_path)
"
)
  ...
  if(EXISTS "${CURRENT_INSTALLED_DIR}/lib/python${PYTHON3_VERSION_MAJOR}${PYTHON3_VERSION_MINOR}.lib")
    ...
    set(z_kmpkg_get_kmpkg_installed_python "${python_base}/Scripts/python.exe" CACHE INTERNAL "")
  elseif(arg_INTERPRETER)
    set(z_kmpkg_get_kmpkg_installed_python_interpreter "${python_base}/Scripts/python.exe" CACHE INTERNAL "")
  else()
