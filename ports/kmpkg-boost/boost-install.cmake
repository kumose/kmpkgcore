...
function(boost_configure_and_install)
  ...
  if(NOT EXISTS "${arg_SOURCE_PATH}/src" OR Z_KMPKG_BOOST_FORCE_HEADER_ONLY) # regex|system|math are header only and only install libs due to compat
    set(headers_only ON)
...
include(BoostRoot)\n"
  ...
  kmpkg_cmake_configure(
    ...
    OPTIONS
      ...
      -DBOOST_RUNTIME_LINK=${KMPKG_CRT_LINKAGE}
  ...
  foreach(config_path IN LISTS cmake_paths)
    ...
    kmpkg_cmake_config_fixup(PACKAGE_NAME ${config_name} CONFIG_PATH lib/cmake/${config_name}-${SEMVER_VERSION} DO_NOT_DELETE_PARENT_CONFIG_PATH)
  endforeach()
  ...
  if(PORT MATCHES "boost-(stacktrace|test)") 
    ...
    kmpkg_cmake_config_fixup(PACKAGE_NAME boost_${boost_lib_name_config} CONFIG_PATH lib/cmake/boost_${boost_lib_name_config}-${SEMVER_VERSION})
  endif()
  ...
  kmpkg_install_copyright(FILE_LIST "${CURRENT_INSTALLED_DIR}/share/boost-cmake/copyright")

  # Install port specific usage
  set(BOOST_PORT_NAME "${boost_lib_name_config}")
  configure_file("${CURRENT_HOST_INSTALLED_DIR}/share/kmpkg-boost/usage.in" "${CURRENT_INSTALLED_DIR}/share/${PORT}/usage")
endfunction()
