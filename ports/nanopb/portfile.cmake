...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" nanopb_BUILD_STATIC_LIBS)
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" nanopb_STATIC_LINKING)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-Dnanopb_PROTOC_PATH=${CURRENT_HOST_INSTALLED_DIR}/tools/protobuf/protoc${KMPKG_HOST_EXECUTABLE_SUFFIX}"
        ${FEATURE_OPTIONS}
