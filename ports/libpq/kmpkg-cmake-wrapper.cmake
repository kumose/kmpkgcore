find_library(PostgreSQL_LIBRARY_RELEASE NAMES pq libpq NAMES_PER_DIR PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH REQUIRED)
find_library(PostgreSQL_LIBRARY_DEBUG NAMES pq libpq NAMES_PER_DIR PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH)
_find_package(${ARGS})
if(PostgreSQL_FOUND AND NOT "@KMPKG_TARGET_IS_WINDOWS@")
...
if(PostgreSQL_FOUND AND "@KMPKG_LIBRARY_LINKAGE@" STREQUAL "static")
    include(SelectLibraryConfigurations)
    foreach(LIB_ITEM pgport pgcommon)
        find_library(PostgreSQL_${LIB_ITEM}_LIBRARY_RELEASE
            NAMES ${LIB_ITEM} lib${LIB_ITEM}
            NAMES_PER_DIR
            PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH
        )
        ...
        find_library(PostgreSQL_${LIB_ITEM}_LIBRARY_DEBUG
            NAMES ${LIB_ITEM} lib${LIB_ITEM}
            NAMES_PER_DIR
            PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH
        )
    ...
    set(Z_KMPKG_PORT_FEATURES "@FEATURES@")
    if("openssl" IN_LIST Z_KMPKG_PORT_FEATURES)
