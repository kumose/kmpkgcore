...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    set(wrong_suffix "${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
else()
    set(wrong_suffix "${KMPKG_TARGET_SHARED_LIBRARY_SUFFIX}")
endif()
...
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/eu-make-debug-archive" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../..")
if("libdebuginfod" IN_LIST FEATURES)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/etc/profile.d/debuginfod.sh" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../..")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/etc/profile.d/debuginfod.csh" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../..")
endif()
