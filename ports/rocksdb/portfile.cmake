...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "dynamic" WITH_MD_LIBRARY)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" ROCKSDB_BUILD_SHARED)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/rocksdb)
