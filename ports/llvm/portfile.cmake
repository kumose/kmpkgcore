...
if(KMPKG_DETECTED_CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" AND KMPKG_DETECTED_MSVC_VERSION LESS "1925")
...
if("flang" IN_LIST FEATURES)
    if(KMPKG_DETECTED_CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" AND KMPKG_TARGET_ARCHITECTURE STREQUAL "x86")
...
if("libcxx" IN_LIST FEATURES)
    if(KMPKG_DETECTED_CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" AND KMPKG_DETECTED_MSVC_VERSION LESS "1914")
...
if("mlir" IN_LIST FEATURES)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/mlir/MLIRConfig.cmake" "set(MLIR_MAIN_SRC_DIR \"${SOURCE_PATH}/mlir\")" "")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/mlir/MLIRConfig.cmake" "${CURRENT_BUILDTREES_DIR}" "\${MLIR_INCLUDE_DIRS}")
endif()
...
# Remove empty directories to avoid kmpkg warning
set(empty_dirs)
if("clang-tools-extra" IN_LIST FEATURES)
