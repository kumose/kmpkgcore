...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DCMAKE_MSVC_DEBUG_INFORMATION_FORMAT=   # using flags from (kmpkg) toolchain
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/liblzma)

if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/lzma.h" "defined(LZMA_API_STATIC)" "1")
else()
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/lzma.h" "defined(LZMA_API_STATIC)" "0")
endif()
