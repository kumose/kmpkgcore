...
set(z_kmpkg_liblzma_fixup_needed 0)
if(NOT "CONFIG" IN_LIST ARGS AND NOT "NO_MODULE" IN_LIST ARGS AND NOT CMAKE_DISABLE_FIND_PACKAGE_LibLZMA)
    get_filename_component(z_kmpkg_liblzma_prefix "${CMAKE_CURRENT_LIST_DIR}" DIRECTORY)
    get_filename_component(z_kmpkg_liblzma_prefix "${z_kmpkg_liblzma_prefix}" DIRECTORY)
    find_path(LIBLZMA_INCLUDE_DIR NAMES lzma.h PATHS "${z_kmpkg_liblzma_prefix}/include" NO_DEFAULT_PATH)
    # liblzma doesn't use a debug postfix, but FindLibLZMA.cmake expects it 
    find_library(LIBLZMA_LIBRARY_RELEASE NAMES lzma PATHS "${z_kmpkg_liblzma_prefix}/lib" NO_DEFAULT_PATH)
    find_library(LIBLZMA_LIBRARY_DEBUG NAMES lzma PATHS "${z_kmpkg_liblzma_prefix}/debug/lib" NO_DEFAULT_PATH)
    unset(z_kmpkg_liblzma_prefix)
    if(CMAKE_VERSION VERSION_LESS 3.16)
        # Older versions of FindLibLZMA.cmake need a single lib in LIBLZMA_LIBRARY.
        set(z_kmpkg_liblzma_fixup_needed 1)
...
if(z_kmpkg_liblzma_fixup_needed)
...
unset(z_kmpkg_liblzma_fixup_needed)
cmake_policy(POP)
