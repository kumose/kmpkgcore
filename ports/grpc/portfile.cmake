...
if(KMPKG_CROSSCOMPILING)
    kmpkg_add_to_path(PREPEND "${CURRENT_HOST_INSTALLED_DIR}/tools/grpc")
endif()

string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" gRPC_MSVC_STATIC_RUNTIME)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" gRPC_STATIC_LINKING)
...
kmpkg_cmake_configure(
    ...
    OPTIONS ${FEATURE_OPTIONS}
        ...
        "-D_gRPC_PROTOBUF_PROTOC_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/protobuf/protoc${KMPKG_HOST_EXECUTABLE_SUFFIX}"
        "-DProtobuf_PROTOC_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/protobuf/protoc${KMPKG_HOST_EXECUTABLE_SUFFIX}"
...
if (gRPC_BUILD_CODEGEN)
    ...
    configure_file("${CMAKE_CURRENT_LIST_DIR}/gRPCTargets-kmpkg-tools.cmake" "${CURRENT_PACKAGES_DIR}/share/grpc/gRPCTargets-kmpkg-tools.cmake" @ONLY)
endif()
