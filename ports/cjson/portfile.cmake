...
if(CMAKE_HOST_WIN32)
    string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" ENABLE_PUBLIC_SYMBOLS)
    string(COMPARE NOTEQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" DENABLE_HIDDEN_SYMBOLS)
else()
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/cJSON)
