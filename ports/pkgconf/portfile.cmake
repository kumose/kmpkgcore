...
if(NOT KMPKG_CROSSCOMPILING)
    ...
    elseif(NOT KMPKG_TARGET_IS_WINDOWS AND KMPKG_TARGET_ARCHITECTURE MATCHES "x64")
        # These defaults are obtained from pkgconf/pkg-config on Ubuntu and OpenSuse
        # kmpkg cannot do system introspection to obtain/set these values since it would break binary caching.
        set(SYSTEM_INCLUDEDIR "/usr/include")
    ...
    elseif(NOT KMPKG_TARGET_IS_WINDOWS AND KMPKG_TARGET_ARCHITECTURE MATCHES "riscv64")
...
if(DEFINED KMPKG_pkgconf_SYSTEM_LIBDIR)
    set(SYSTEM_LIBDIR "${KMPKG_pkgconf_SYSTEM_LIBDIR}")
endif()
if(DEFINED KMPKG_pkgconf_PKG_DEFAULT_PATH)
    set(PKG_DEFAULT_PATH "${KMPKG_pkgconf_PKG_DEFAULT_PATH}")
endif()
if(DEFINED KMPKG_pkgconf_SYSTEM_INCLUDEDIR)
    set(SYSTEM_INCLUDEDIR "${KMPKG_pkgconf_SYSTEM_INCLUDEDIR}")
endif()
if(DEFINED KMPKG_pkgconf_PERSONALITY_PATH)
    set(PERSONALITY_PATH "${KMPKG_pkgconf_PERSONALITY_PATH}")
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/pkgconf/libpkgconf/libpkgconf-api.h" "#if defined(PKGCONFIG_IS_STATIC)" "#if 1")
endif()

kmpkg_copy_tools(TOOL_NAMES bomtool pkgconf AUTO_CLEAN)
