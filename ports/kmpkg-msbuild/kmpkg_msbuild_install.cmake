function(kmpkg_msbuild_install)
    ...
    if(NOT arg_NO_TOOLCHAIN_PROPS)
        file(RELATIVE_PATH project_root "${arg_SOURCE_PATH}/${arg_PROJECT_SUBPATH}" "${arg_SOURCE_PATH}") # required by z_kmpkg_msbuild_create_props
        z_kmpkg_msbuild_create_props(OUTPUT_PROPS props_file
