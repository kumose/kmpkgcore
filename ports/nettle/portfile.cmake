...
set(asmflags "")
if(KMPKG_DETECTED_CMAKE_C_COMPILER_ID STREQUAL "MSVC")
    kmpkg_list(APPEND OPTIONS ac_cv_func_memset=yes)
...
if(disable_assembly)
    kmpkg_list(APPEND OPTIONS "--enable-assembler=no")
elseif(ccas)
    cmake_path(GET ccas PARENT_PATH ccas_dir)
    kmpkg_add_to_path("${ccas_dir}")
    cmake_path(GET ccas FILENAME ccas_command)
    kmpkg_list(APPEND OPTIONS "CCAS=${ccas_command}" "ASM_FLAGS=${asmflags}")
endif()
...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    kmpkg_list(APPEND OPTIONS "MSVC_TARGET=${KMPKG_TARGET_ARCHITECTURE}")
else()
    kmpkg_list(APPEND OPTIONS "MSVC_TARGET=no")
endif()
...
if(NOT KMPKG_CROSSCOMPILING)
    ...
    list(TRANSFORM tool_names APPEND "${KMPKG_HOST_EXECUTABLE_SUFFIX}")
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/COPYINGv3")
