...
if ("openssl" IN_LIST FEATURES)
    kmpkg_list(APPEND options "--enable-openssl-compatibility")
endif()

if(KMPKG_TARGET_IS_WINDOWS)
    kmpkg_list(APPEND options "LIBS=\$LIBS -liconv -lcharset") # for libunistring
endif()

if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_list(APPEND options "ac_cv_dlopen_soname_works=no") # ensure kmpkg libs
endif()
