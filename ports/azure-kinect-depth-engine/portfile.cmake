set(KMPKG_POLICY_EMPTY_INCLUDE_FOLDER enabled) # runtime only

kmpkg_download_distfile(BLOB_ARCHIVE
...
if(KMPKG_TARGET_IS_LINUX)
    file(COPY "${PACKAGE_PATH}/linux/lib/native/${KMPKG_TARGET_ARCHITECTURE}/release/libdepthengine.so.2.0" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
    if(NOT KMPKG_BUILD_TYPE)
      file(COPY "${PACKAGE_PATH}/linux/lib/native/${KMPKG_TARGET_ARCHITECTURE}/release/libdepthengine.so.2.0" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
    endif()
elseif(KMPKG_TARGET_IS_WINDOWS)
    string(REPLACE "x64" "amd64" ARCHITECTURE "${KMPKG_TARGET_ARCHITECTURE}")
