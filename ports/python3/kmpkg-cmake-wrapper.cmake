...
# kmpkg_find_acquire_program(PYTHON3) and prevents the kmpkg toolchain from
# stomping on FindPython's default functionality.
list(REMOVE_ITEM CMAKE_PROGRAM_PATH "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/tools/python3")
...
# CMake's FindPython's separation of concerns is very muddy. We only want to force kmpkg's Python
...
# interpreter matching kmpkg's Python libraries. Note that the "Development" component implies
...
if(_PythonFinder_WantLibs)
    ...
    if(_PythonFinder_WantInterp)
        find_program(
            ...
            PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/tools/python3"
            NO_DEFAULT_PATH
        )
    endif()
