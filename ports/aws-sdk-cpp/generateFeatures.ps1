...
param(
    ...
    [Parameter(Mandatory=$false)][string]$kmpkg = "$PSScriptRoot/../../kmpkg"
)

$ErrorActionPreference = "Stop"

$ManifestIn = "$PortDirectory/kmpkg.in.json"
$ManifestOut = "$PortDirectory/kmpkg.json"

$manifest = Get-Content $ManifestIn | ConvertFrom-Json
$version = $manifest.version

Write-Host "Using version from kmpkg.in.json: $version"
...
$manifest | Add-Member `
    ...
    -NotePropertyValue 'Automatically generated by generateFeatures.ps1 from kmpkg.in.json, do not edit manually'
...
& $kmpkg format-manifest --feature-flags=-manifests $ManifestOut
