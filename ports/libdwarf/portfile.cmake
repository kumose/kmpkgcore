...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" BUILD_NON_SHARED)
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/libdwarf")
kmpkg_fixup_pkgconfig()
kmpkg_copy_pdbs()
kmpkg_copy_tools(TOOL_NAMES dwarfdump AUTO_CLEAN)

if(BUILD_SHARED)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/libdwarf/libdwarf.h" "ifndef LIBDWARF_STATIC" "if 1")
endif()
