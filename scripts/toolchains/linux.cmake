if(NOT _KMPKG_LINUX_TOOLCHAIN)
    set(_KMPKG_LINUX_TOOLCHAIN 1)
    ...
    elseif(KMPKG_TARGET_ARCHITECTURE STREQUAL "x86")
       ...
       string(APPEND KMPKG_C_FLAGS " -m32")
       string(APPEND KMPKG_CXX_FLAGS " -m32")
       string(APPEND KMPKG_LINKER_FLAGS " -m32")
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux" AND CMAKE_SYSTEM_PROCESSOR AND NOT CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL CMAKE_SYSTEM_PROCESSOR)
        ...
        message(STATUS "Cross-compiling for target ${KMPKG_TARGET_ARCHITECTURE} (${CMAKE_SYSTEM_PROCESSOR}) on host ${KMPKG_HOST_ARCHITECTURE} (${CMAKE_HOST_SYSTEM_PROCESSOR}).")
    endif()
    ...
    string(APPEND CMAKE_ASM_FLAGS_INIT " ${KMPKG_C_FLAGS} ")
endif()
