if(NOT _KMPKG_MINGW_TOOLCHAIN)
    set(_KMPKG_MINGW_TOOLCHAIN 1)
    ...
    # Need to override MinGW from KMPKG_CMAKE_SYSTEM_NAME
    ...
    string(APPEND CMAKE_C_FLAGS_INIT " ${KMPKG_C_FLAGS} ")
    string(APPEND CMAKE_CXX_FLAGS_INIT " ${KMPKG_CXX_FLAGS} ")
