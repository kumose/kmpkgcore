...
function findExistingImportModuleDirectives([Parameter(Mandatory=$true)][string]$path)
{
    ...
    $fileContents -match 'Import-Module.+?(?=posh-kmpkg)'
    return
}

$scriptsDir = split-path -parent $script:MyInvocation.MyCommand.Definition

$profileEntry = "Import-Module '$scriptsDir\posh-kmpkg'"
...
if ($existingImports.Count -gt 0)
{
    ...
    Write-Host "`nposh-kmpkg is already imported to your PowerShell profile. The following entries were found:"
...
if (Test-Path $profilePath)
{
    ...
    {
        Write-Warning "Skipping add of posh-kmpkg import to profile; '$profilePath' appears to be signed."
...
Write-Host "`nSuccessfully added posh-kmpkg to your PowerShell profile. Please start a new PowerShell window for the changes to take effect."
