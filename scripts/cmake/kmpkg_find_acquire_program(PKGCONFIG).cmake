macro(z_kmpkg_find_acquire_pkgconfig_msys_declare_packages)
...
elseif(CMAKE_HOST_WIN32)
    if(NOT EXISTS "${PKGCONFIG}")
        ...
        if("${host_arch}" STREQUAL "ARM64")
            kmpkg_acquire_msys(PKGCONFIG_ROOT
                NO_DEFAULT_PACKAGES
                Z_DECLARE_EXTRA_PACKAGES_COMMAND "z_kmpkg_find_acquire_pkgconfig_msys_declare_packages"
    ...
    if(KMPKG_HOST_IS_OSX)
        kmpkg_list(PREPEND paths_to_search "/opt/homebrew/bin")
    endif()
endif()
