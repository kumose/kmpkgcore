function(kmpkg_fixup_cmake_targets)
    if(Z_KMPKG_CMAKE_CONFIG_FIXUP_GUARD)
        message(FATAL_ERROR "The ${PORT} port already depends on kmpkg-cmake-config; using both kmpkg-cmake-config and kmpkg_fixup_cmake_targets in the same port is unsupported.")
    endif()
    ...
    if(arg_UNPARSED_ARGUMENTS)
        message(FATAL_ERROR "kmpkg_fixup_cmake_targets was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
