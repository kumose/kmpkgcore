function(z_kmpkg_configure_gn_generate)
...
function(kmpkg_configure_gn)
    if(Z_KMPKG_GN_CONFIGURE_GUARD)
        message(FATAL_ERROR "The ${PORT} port already depends on kmpkg-gn; using both kmpkg-gn and kmpkg_configure_gn in the same port is unsupported.")
    else()
        message("${Z_KMPKG_BACKCOMPAT_MESSAGE_LEVEL}" "This function 'kmpkg_configure_gn' is obsolete. Use 'kmpkg_gn_configure' in port 'kmpkg-gn'.")
    endif()

    cmake_parse_arguments(PARSE_ARGV 0 "arg" "" "SOURCE_PATH;OPTIONS;OPTIONS_DEBUG;OPTIONS_RELEASE" "")
    if(DEFINED arg_UNPARSED_ARGUMENTS)
        message(WARNING "kmpkg_configure_gn was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
