function(kmpkg_build_cmake)
    ...
    if(Z_KMPKG_CMAKE_BUILD_GUARD)
        message(FATAL_ERROR "The ${PORT} port already depends on kmpkg-cmake; using both kmpkg-cmake and kmpkg_build_cmake in the same port is unsupported.")
    endif()
    ...
    elseif(Z_KMPKG_CMAKE_GENERATOR STREQUAL "Xcode")
        ...
        message(FATAL_ERROR "Unrecognized GENERATOR setting from kmpkg_configure_cmake(). Valid generators are: Ninja, Visual Studio, and NMake Makefiles")
    endif()
