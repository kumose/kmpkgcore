include(kmpkg_execute_in_download_mode)
...
function(kmpkg_from_gitlab)
    ...
    if(DEFINED arg_UNPARSED_ARGUMENTS)
        message(WARNING "kmpkg_from_gitlab was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
    ...
    if(DEFINED arg_FILE_DISAMBIGUATOR AND NOT KMPKG_USE_HEAD_VERSION)
    ...
    # When multiple kmpkg_from_gitlab's are used after each other, only use the version from the first (hopefully the primary one).
    if(KMPKG_USE_HEAD_VERSION AND NOT DEFINED KMPKG_HEAD_VERSION)
        ...
        set(KMPKG_HEAD_VERSION "${CMAKE_MATCH_2}" PARENT_SCOPE)
    endif()
