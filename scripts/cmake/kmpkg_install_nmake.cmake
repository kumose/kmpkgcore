function(kmpkg_install_nmake)
    kmpkg_list(SET multi_value_args
        TARGET
    ...
    kmpkg_list(SET extra_args)
    # switch args
    if(arg_NO_DEBUG)
        kmpkg_list(APPEND extra_args NO_DEBUG)
    endif()
    if(arg_PREFER_JOM)
        kmpkg_list(APPEND extra_args PREFER_JOM)
    endif()

    # single args
    foreach(arg IN ITEMS PROJECT_SUBPATH PROJECT_NAME CL_LANGUAGE)
        if(DEFINED "arg_${arg}")
            kmpkg_list(APPEND extra_args ${arg} "${arg_${arg}}")
        endif()
    endforeach()
