function(kmpkg_copy_tools)
    ...
    foreach(tool_name IN LISTS arg_TOOL_NAMES)
        set(tool_path "${arg_SEARCH_DIR}/${tool_name}${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
        set(tool_pdb "${arg_SEARCH_DIR}/${tool_name}.pdb")
        if(EXISTS "${tool_path}")
            file(COPY "${tool_path}" DESTINATION "${arg_DESTINATION}")
        elseif(NOT "${KMPKG_TARGET_BUNDLE_SUFFIX}" STREQUAL "" AND NOT "${KMPKG_TARGET_BUNDLE_SUFFIX}" STREQUAL "${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
            set(bundle_path "${arg_SEARCH_DIR}/${tool_name}${KMPKG_TARGET_BUNDLE_SUFFIX}")
    ...
    if(arg_AUTO_CLEAN)
        kmpkg_clean_executables_in_bin(FILE_NAMES ${arg_TOOL_NAMES})
    endif()

    kmpkg_copy_tool_dependencies("${arg_DESTINATION}")
endfunction()
