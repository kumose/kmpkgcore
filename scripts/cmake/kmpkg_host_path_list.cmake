function(kmpkg_host_path_list)
    if("${ARGC}" LESS "2")
        message(FATAL_ERROR "kmpkg_host_path_list requires at least two arguments.")
    endif()

    if("${ARGV1}" MATCHES "^ARGV([0-9]*)$|^ARG[CN]$|^CMAKE_CURRENT_FUNCTION|^CMAKE_MATCH_")
        message(FATAL_ERROR "kmpkg_host_path_list does not support the list_var being ${ARGV1}.
    ...
    elseif("${ARGV1}" MATCHES [[^([A-Z]+)\{.*\}$]])
        message(FATAL_ERROR "kmpkg_host_path_list does not support ${CMAKE_MATCH_1} variables;
    ...
    list(FILTER bad_items INCLUDE REGEX "[${KMPKG_HOST_PATH_SEPARATOR}]")
    if(NOT "${bad_items}" STREQUAL "")
        message(FATAL_ERROR "Host path separator (${KMPKG_HOST_PATH_SEPARATOR}) in path; this is unsupported.")
    endif()
    ...
    elseif("${operation}" STREQUAL "APPEND")
        ...
        elseif(NOT "${arguments}" STREQUAL "")
            set(list "${list}${KMPKG_HOST_PATH_SEPARATOR}${arguments}")
        endif()
    elseif("${operation}" STREQUAL "PREPEND")
        ...
        if("${list}" STREQUAL "")
            set(list "${arguments}")
        elseif(NOT "${arguments}" STREQUAL "")
            set(list "${arguments}${KMPKG_HOST_PATH_SEPARATOR}${list}")
        endif()
    elseif("${operation}" STREQUAL "REMOVE_DUPLICATES")
        if(NOT KMPKG_HOST_PATH_SEPARATOR STREQUAL ";")
