function(kmpkg_install_msbuild)
    cmake_parse_arguments(
        PARSE_ARGV 0
        "arg"
        "USE_KMPKG_INTEGRATION;ALLOW_ROOT_INCLUDES;REMOVE_ROOT_INCLUDES;SKIP_CLEAN"
    ...
    if(DEFINED arg_UNPARSED_ARGUMENTS)
        message(WARNING "kmpkg_install_msbuild was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
    ...
    list(APPEND arg_OPTIONS
        ...
        "/p:MultiProcMaxCount=${KMPKG_CONCURRENCY}"
