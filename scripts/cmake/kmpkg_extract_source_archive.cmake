function(z_kmpkg_extract_source_archive_deprecated_mode archive working_directory)
    ...
    if(NOT EXISTS "${working_directory}/${archive_filename}.extracted")
        ...
        kmpkg_extract_archive(ARCHIVE "${archive}" DESTINATION "${working_directory}")
        file(TOUCH "${working_directory}/${archive_filename}.extracted")
    endif()
endfunction()

function(kmpkg_extract_source_archive)
    if(ARGC LESS_EQUAL "2")
        z_kmpkg_deprecation_message( "Deprecated form of kmpkg_extract_source_archive used:
    Please use the `kmpkg_extract_source_archive(<out-var> ARCHIVE <archive>)` form.")
        if(ARGC EQUAL "0")
            message(FATAL_ERROR "kmpkg_extract_source_archive requires at least one argument.")
        endif()
        ...
        z_kmpkg_extract_source_archive_deprecated_mode("${archive}" "${working_directory}")
        return()
    endif()
