function(kmpkg_from_bitbucket)
    ...
    if(DEFINED arg_UNPARSED_ARGUMENTS)
        message(WARNING "kmpkg_from_bitbucket was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}")
    endif()
    ...
    if(KMPKG_USE_HEAD_VERSION)
        ...
        # TODO: add json-pointer support to kmpkg
...
")
        ...
        set(KMPKG_HEAD_VERSION "${CMAKE_MATCH_1}" PARENT_SCOPE)
    endif()
