function(z_kmpkg_escape_regex_control_characters out_var string)
    if(ARGC GREATER "2")
        message(FATAL_ERROR "z_kmpkg_escape_regex_control_characters passed extra arguments: ${ARGN}")
    endif()
