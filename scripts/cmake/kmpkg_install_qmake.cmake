function(kmpkg_install_qmake)
    z_kmpkg_function_arguments(args)

    kmpkg_build_qmake(${args})
    ...
    if("${release_libs}" STREQUAL "" AND "${debug_libs}" STREQUAL "")
        message(FATAL_ERROR "Build did not appear to produce any libraries. If this is intended, use `kmpkg_build_qmake()` directly.")
    endif()
