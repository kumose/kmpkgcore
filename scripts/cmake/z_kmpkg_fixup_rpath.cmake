function(z_kmpkg_calculate_corrected_rpath)
    ...
    if(NOT "${arg_ORG_RPATH}" STREQUAL "")
        ...
        if(NOT X_KMPKG_RPATH_KEEP_SYSTEM_PATHS)
...
function(z_kmpkg_fixup_rpath_in_dir)
    ...
    if(KMPKG_DOWNLOAD_MODE)
        kmpkg_find_acquire_program(PATCHELF)
    endif()
    ...
    foreach(folder IN LISTS root_entries)
        ...
        foreach(elf_file IN LISTS elf_files)
            ...
            kmpkg_find_acquire_program(PATCHELF) # Note that this relies on kmpkg_find_acquire_program short
            ...
            z_kmpkg_calculate_corrected_rpath(
